        ...
        <div class="row">
            ...
            <?php if (!empty($_SESSION['cities'])): ?>
                <? foreach ($_SESSION['cities'] as $_city):
                    $data = get_data($_city);
                ?>
                    <div class="col-md-4 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-6 col-xs-offset-3 weather-card show <?= $data->list[0]->weather[0]->main ?>">
                <div class="main-infos">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <div class="town"><?= ucwords($data->city->name) ?></div>
                            <div class="weather-state"><?= $data->list[0]->weather[0]->description ?></div>
                            <div class="temperature"><?= intval($data->list[0]->main->temp) ?>°</div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="temperature-date">
                            <span class="text-left col-md-6 col-sm-6 col-xs-6">
                                <span><?= date('l', $data->list[0]->dt) ?></span>
                            </span>
                            <span class="text-right col-md-6 col-sm-6 col-xs-6">
                                <span><?= intval($data->list[0]->main->temp_max) ?></span>
                                <span> | </span>
                                <span><?= intval($data->list[0]->main->temp_min) ?></span>
                            </span>
                        </div>
                    </div>
<!--
...
-->
            ...
            <div class="col-md-4 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-6 col-xs-offset-3 weather-card show add-card">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
